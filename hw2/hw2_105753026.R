...
if (length(args)==0) {
  stop("USAGE: Rscript hw2_105753026.R --input test.fasta --score pam250.txt --aln global --gap_open -10 --gap_extend -2 --output result.fasta", call.=FALSE)
}
...
write(c(seq_name[1], aln_seq1, seq_name[2], aln_seq2), file = o_f)
